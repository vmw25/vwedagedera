...
assert.match(html, /Anki cards that/);
...
assert.match(html, /Public installers are not available yet/);
...
assert.doesNotMatch(html, /data-download-state=(?:"ready"|ready)|data-installer=/, 'No public installer is ready');
