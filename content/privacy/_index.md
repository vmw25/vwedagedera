    ...
    content:
      ...
      description: |
        ...
        **Newsletter subscriptions.** If you choose to subscribe, this website collects your email address so that Vidun can send you a short notification when a new article is published. The email will contain a preview and a link to continue reading on this website.
        ...
        Subscriptions are managed through [Kit](https://kit.com/privacy). You will be asked to confirm your address before receiving the newsletter. Your email address is used only for this newsletter, is not sold, and is kept until you unsubscribe or the mailing list is cleaned.

        Every newsletter includes an unsubscribe link. You can withdraw your consent at any time. For questions about your information, email [vmw25@cam.ac.uk](mailto:vmw25@cam.ac.uk).
---
